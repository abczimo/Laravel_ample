...
var inlite = (function () {
  ...
  var $_4w6ut7165jctdj8ll = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_4ynp3c169jctdj8lq.fromClientRect(clientRect)) : null;
  };
  var $_15pb8z168jctdj8lo = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          return $_dwywxn167jctdj8ln.result(predicateIds[i].id, $_15pb8z168jctdj8lo.getElementRect(editor, element));
        }
      }
      return null;
    };
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_dwywxn167jctdj8ln.result(predicateIds[x].id, $_15pb8z168jctdj8lo.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        return $_dwywxn167jctdj8ln.result(id, $_15pb8z168jctdj8lo.getSelectionRect(editor));
      }
      return null;
    };
  };
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_6sbb616ijctdj8m0.isArray(value)) {
      return value;
    } else if ($_6sbb616ijctdj8m0.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_6sbb616ijctdj8m0.isBoolean(value)) {
  ...
  var $_7fjtah16hjctdj8ly = {
    getStringOr: getByTypeOr($_6sbb616ijctdj8m0.isString),
    getBoolOr: getByTypeOr($_6sbb616ijctdj8m0.isBoolean),
    getNumberOr: getByTypeOr($_6sbb616ijctdj8m0.isNumber),
    getHandlerOr: getByTypeOr($_6sbb616ijctdj8m0.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_6sbb616ijctdj8m0.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_4ynp3c169jctdj8lq.toClientRect(targetRect),
        contentAreaRect: $_4ynp3c169jctdj8lq.toClientRect(contentAreaRect),
        panelRect: $_4ynp3c169jctdj8lq.toClientRect(panelRect)
      });
      return $_4ynp3c169jctdj8lq.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_7fjtah16hjctdj8ly.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_7fjtah16hjctdj8ly.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_7fjtah16hjctdj8ly.getHandlerOr(editor, 'inline_toolbar_position_handler', $_50es7616jjctdj8m1.defaultHandler);
  };
  ...
  var fireSkinLoaded = function (editor, callback) {
    var done = function () {
      ...
      $_1jqo1c16ejctdj8lv.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_t9nt716fjctdj8lw.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded(editor, callback);
    };
    if ($_t9nt716fjctdj8lw.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_3bo8ed16djctdj8lu = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_4w6ut7165jctdj8ll.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_dtf7r816ajctdj8lr.fromContextToolbars(toolbars);
    result = $_dwywxn167jctdj8ln.match(editor, [
      $_4mn7td166jctdj8lm.element(elements[0], contextToolbarsPredicateIds),
      $_6sc8ma16cjctdj8ls.textSelection('text'),
      $_6sc8ma16cjctdj8ls.emptyTextBlock(elements, 'insert'),
      $_4mn7td166jctdj8lm.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_dwywxn167jctdj8ln.match(editor, [$_6sc8ma16cjctdj8ls.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_3bo8ed16djctdj8lu.load(editor, function () {
  ...
  var $_diu4z2161jctdj8ld = { renderUI: renderUI };
  ...
  var never = $_9tiuzt16ojctdj8mh.never;
  var always = $_9tiuzt16ojctdj8mh.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_9tiuzt16ojctdj8mh.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var indexOf = function (xs, x) {
    ...
    return r === -1 ? $_2410no16njctdj8me.none() : $_2410no16njctdj8me.some(r);
  };
  ...
  var find = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_2410no16njctdj8me.some(x);
      }
    }
    return $_2410no16njctdj8me.none();
  };
  var findIndex = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_2410no16njctdj8me.some(i);
      }
    }
    return $_2410no16njctdj8me.none();
  };
  ...
  var head = function (xs) {
    return xs.length === 0 ? $_2410no16njctdj8me.none() : $_2410no16njctdj8me.some(xs[0]);
  };
  var last = function (xs) {
    return xs.length === 0 ? $_2410no16njctdj8me.none() : $_2410no16njctdj8me.some(xs[xs.length - 1]);
  };
  var $_7deqd516mjctdj8m9 = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var proto = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_4eznf216vjctdj8no.parseBox(settings.border);
      self.paddingBox = $_4eznf216vjctdj8no.parseBox(settings.padding);
      self.marginBox = $_4eznf216vjctdj8no.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_4eznf216vjctdj8no.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_4eznf216vjctdj8no.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_4eznf216vjctdj8no.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_8650z8172jctdj8o7.remove(this);
  ...
  var NotificationManagerImpl = function (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_7deqd516mjctdj8m9.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_7deqd516mjctdj8m9.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_4eznf216vjctdj8no.parseBox(self.settings.border);
          ...
          self.borderBox = $_4eznf216vjctdj8no.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_diu4z2161jctdj8ld.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_5y47of160jctdj8lb = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_cppgr917mjctdj8qk.resolve(name, scope);
  };
  ...
  var $_7xm3r17ljctdj8qi = { getOrDie: getOrDie };

  var FileReader = function () {
    var f = $_7xm3r17ljctdj8qi.getOrDie('FileReader');
    return new f();
  };
  ...
  var $_2z1wrr17jjctdj8qe = { blobToBase64: blobToBase64 };
  ...
  var $_18juyz17pjctdj8qm = { pickFile: pickFile };
  ...
  var $_vsdk417rjctdj8qw = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_a3katg17tjctdj8r3.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_a3katg17tjctdj8r3.resolve(dom, bookmark));
  };
  ...
  var $_f1lwrq17sjctdj8r1 = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_vsdk417rjctdj8qw.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_f1lwrq17sjctdj8r1.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_1v9r0c17qjctdj8qo.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_18juyz17pjctdj8qm.pickFile().then(function (files) {
          var blob = files[0];
          $_2z1wrr17jjctdj8qe.blobToBase64(blob).then(function (base64) {
            $_1v9r0c17qjctdj8qo.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_1v9r0c17qjctdj8qo.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_30t6ts17ijctdj8q0 = { addToEditor: addToEditor };
  ...
  var getUiContainerDelta = function () {
    ...
    if (uiContainer && DOMUtils.DOM.getStyle(uiContainer, 'position', true) !== 'static') {
      ...
      return $_2410no16njctdj8me.some({
        x: dx,
        y: dy
      });
    } else {
  ...
  var $_85dk0z17xjctdj8rb = { getUiContainerDelta: getUiContainerDelta };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_58hgpa17zjctdj8rh.isAbsolute(href) && $_58hgpa17zjctdj8rh.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_1v9r0c17qjctdj8qo.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_1v9r0c17qjctdj8qo.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_2umy3617yjctdj8re = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_6sbb616ijctdj8m0.isArray(items)) {
      return items;
    } else if ($_6sbb616ijctdj8m0.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
  ...
  var $_3udoij180jctdj8rj = { create: create$2 };

  var Panel$1 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_3udoij180jctdj8rj.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_3udoij180jctdj8rj.create(editor, 'text', $_t9nt716fjctdj8lw.getTextSelectionToolbarItems(editor)),
        $_3udoij180jctdj8rj.create(editor, 'insert', $_t9nt716fjctdj8lw.getInsertToolbarItems(editor)),
        $_2umy3617yjctdj8re.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_t9nt716fjctdj8lw.getPositionHandler(editor);
      contentAreaRect = $_15pb8z168jctdj8lo.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_50es7616jjctdj8m1.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_50es7616jjctdj8m1.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_85dk0z17xjctdj8rb.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_50es7616jjctdj8m1.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_15pb8z168jctdj8lo.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_50es7616jjctdj8m1.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_50es7616jjctdj8m1.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_1jqo1c16ejctdj8lv.fireBeforeRenderUI(editor);
  ...
  var $_1ufj7f18njctdj8ts = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_9tiuzt16ojctdj8mh.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return $_2410no16njctdj8me.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_g88mc918ojctdj8tu = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_zffrf18sjctdj8ue = { cached: cached };

  var $_3enymo18ujctdj8um = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_3enymo18ujctdj8um.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_3enymo18ujctdj8um.ELEMENT);
  var isText = isType$1($_3enymo18ujctdj8um.TEXT);
  var isDocument = isType$1($_3enymo18ujctdj8um.DOCUMENT);
  var $_7fw56c18tjctdj8ul = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_7fw56c18tjctdj8ul.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_zffrf18sjctdj8ue.cached(function () {
    return getBody($_g88mc918ojctdj8tu.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_g88mc918ojctdj8tu.fromDom(body);
  };
  var $_4dkqzb18rjctdj8uc = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  var Immutable = function () {
    ...
    return function () {
      ...
      var struct = {};
      $_7deqd516mjctdj8m9.each(fields, function (name, i) {
        struct[name] = $_9tiuzt16ojctdj8mh.constant(values[i]);
      });
      return struct;
    };
  };
  ...
  var validateStrArr = function (label, array) {
    if (!$_45ot4v18wjctdj8uv.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_7deqd516mjctdj8m9.each(array, function (a) {
      if (!$_45ot4v18wjctdj8uv.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_7deqd516mjctdj8m9.find(sorted, function (s, i) {
  ...
  var MixedBag = function (required, optional) {
    ...
    $_ghnw5x191jctdj8v4.validateStrArr('required', required);
    $_ghnw5x191jctdj8v4.validateStrArr('optional', optional);
    $_ghnw5x191jctdj8v4.checkDupes(everything);
    return function (obj) {
      var keys = $_dcwh0o190jctdj8v1.keys(obj);
      var allReqd = $_7deqd516mjctdj8m9.forall(required, function (req) {
        return $_7deqd516mjctdj8m9.contains(keys, req);
      });
      if (!allReqd)
        $_ghnw5x191jctdj8v4.reqMessage(required, keys);
      var unsupported = $_7deqd516mjctdj8m9.filter(keys, function (key) {
        return !$_7deqd516mjctdj8m9.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_ghnw5x191jctdj8v4.unsuppMessage(unsupported);
      var r = {};
      $_7deqd516mjctdj8m9.each(required, function (req) {
        r[req] = $_9tiuzt16ojctdj8mh.constant(obj[req]);
      });
      $_7deqd516mjctdj8m9.each(optional, function (opt) {
        r[opt] = $_9tiuzt16ojctdj8mh.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? $_2410no16njctdj8me.some(obj[opt]) : $_2410no16njctdj8me.none());
      });
      return r;
    };
  };

  var $_83f0nb18xjctdj8ux = {
    immutable: Immutable,
  ...
  var $_day3hg192jctdj8v6 = { toArray: toArray };

  var node = function () {
    var f = $_7xm3r17ljctdj8qi.getOrDie('Node');
    return f;
  };
  ...
  var unknown = function () {
    return nu({
      current: undefined,
      version: $_exeiul198jctdj8vj.unknown()
    });
  };
  ...
  var $_db7ri197jctdj8vg = {
    unknown: unknown,
    nu: nu,
    edge: $_9tiuzt16ojctdj8mh.constant(edge),
    chrome: $_9tiuzt16ojctdj8mh.constant(chrome),
    ie: $_9tiuzt16ojctdj8mh.constant(ie),
    opera: $_9tiuzt16ojctdj8mh.constant(opera),
    firefox: $_9tiuzt16ojctdj8mh.constant(firefox),
    safari: $_9tiuzt16ojctdj8mh.constant(safari)
  };
  ...
  var $_84ec26199jctdj8vl = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_9tiuzt16ojctdj8mh.constant(windows$1),
    ios: $_9tiuzt16ojctdj8mh.constant(ios),
    android: $_9tiuzt16ojctdj8mh.constant(android),
    linux: $_9tiuzt16ojctdj8mh.constant(linux),
    osx: $_9tiuzt16ojctdj8mh.constant(osx),
    solaris: $_9tiuzt16ojctdj8mh.constant(solaris),
    freebsd: $_9tiuzt16ojctdj8mh.constant(freebsd)
  };
  ...
  var DeviceType = function (os, browser, userAgent) {
    ...
    return {
      isiPad: $_9tiuzt16ojctdj8mh.constant(isiPad),
      isiPhone: $_9tiuzt16ojctdj8mh.constant(isiPhone),
      isTablet: $_9tiuzt16ojctdj8mh.constant(isTablet),
      isPhone: $_9tiuzt16ojctdj8mh.constant(isPhone),
      isTouch: $_9tiuzt16ojctdj8mh.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_9tiuzt16ojctdj8mh.constant(iOSwebview)
    };
  };

  var detect$3 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_7deqd516mjctdj8m9.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$3(browsers, userAgent).map(function (browser) {
      var version = $_exeiul198jctdj8vj.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$3(oses, userAgent).map(function (os) {
      var version = $_exeiul198jctdj8vj.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var head$1 = function (str) {
    return str === '' ? $_2410no16njctdj8me.none() : $_2410no16njctdj8me.some(str.substr(0, 1));
  };
  var tail = function (str) {
    return str === '' ? $_2410no16njctdj8me.none() : $_2410no16njctdj8me.some(str.substring(1));
  };
  var $_6ilusm19fjctdj8w1 = {
    first: first,
    last: last$1,
    head: head$1,
    tail: tail
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_km0xz19ejctdj8vz.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_km0xz19ejctdj8vz.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_km0xz19ejctdj8vz.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_km0xz19ejctdj8vz.addToEnd(str, prefix);
  };
  var contains$2 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_6ilusm19fjctdj8w1.head(str).bind(function (head) {
      return $_6ilusm19fjctdj8w1.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_cyfsmr19djctdj8vx.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_cyfsmr19djctdj8vx.contains(uastring, 'edge/') && $_cyfsmr19djctdj8vx.contains(uastring, 'chrome') && $_cyfsmr19djctdj8vx.contains(uastring, 'safari') && $_cyfsmr19djctdj8vx.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_cyfsmr19djctdj8vx.contains(uastring, 'chrome') && !$_cyfsmr19djctdj8vx.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_cyfsmr19djctdj8vx.contains(uastring, 'msie') || $_cyfsmr19djctdj8vx.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_cyfsmr19djctdj8vx.contains(uastring, 'safari') || $_cyfsmr19djctdj8vx.contains(uastring, 'mobile/')) && $_cyfsmr19djctdj8vx.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_cyfsmr19djctdj8vx.contains(uastring, 'iphone') || $_cyfsmr19djctdj8vx.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_21zfy619cjctdj8vs = {
    browsers: $_9tiuzt16ojctdj8mh.constant(browsers),
    oses: $_9tiuzt16ojctdj8mh.constant(oses)
  };

  var detect$1 = function (userAgent) {
    var browsers = $_21zfy619cjctdj8vs.browsers();
    var oses = $_21zfy619cjctdj8vs.oses();
    var browser = $_gfw9h019bjctdj8vq.detectBrowser(browsers, userAgent).fold($_db7ri197jctdj8vg.unknown, $_db7ri197jctdj8vg.nu);
    var os = $_gfw9h019bjctdj8vq.detectOs(oses, userAgent).fold($_84ec26199jctdj8vl.unknown, $_84ec26199jctdj8vl.nu);
  ...
  var $_9gaucf196jctdj8vf = { detect: detect$1 };

  var detect = $_zffrf18sjctdj8ue.cached(function () {
    var userAgent = navigator.userAgent;
    return $_9gaucf196jctdj8vf.detect(userAgent);
  });
  var $_el7bpe195jctdj8vd = { detect: detect };

  var ELEMENT = $_3enymo18ujctdj8um.ELEMENT;
  var DOCUMENT = $_3enymo18ujctdj8um.DOCUMENT;
  ...
  var all$2 = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_7deqd516mjctdj8m9.map(base.querySelectorAll(selector), $_g88mc918ojctdj8tu.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? $_2410no16njctdj8me.none() : $_2410no16njctdj8me.from(base.querySelector(selector)).map($_g88mc918ojctdj8tu.fromDom);
  };
  var $_3z157z19gjctdj8w2 = {
    all: all$2,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_7deqd516mjctdj8m9.exists(elements, $_9tiuzt16ojctdj8mh.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_3n9oqs194jctdj8vc.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_el7bpe195jctdj8vd.detect().browser;
  var contains$1 = browser.isIE() ? ieContains : regularContains;
  var $_3d886r193jctdj8v7 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$1,
    is: $_3z157z19gjctdj8w2.is
  };

  var owner = function (element) {
    return $_g88mc918ojctdj8tu.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_g88mc918ojctdj8tu.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_g88mc918ojctdj8tu.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return $_2410no16njctdj8me.from(dom.parentNode).map($_g88mc918ojctdj8tu.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children$2(p);
      return $_7deqd516mjctdj8m9.findIndex(kin, function (elem) {
        return $_3d886r193jctdj8v7.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_45ot4v18wjctdj8uv.isFunction(isRoot) ? isRoot : $_9tiuzt16ojctdj8mh.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_g88mc918ojctdj8tu.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings$2 = function (element) {
    var filterSelf = function (elements) {
      return $_7deqd516mjctdj8m9.filter(elements, function (x) {
        return !$_3d886r193jctdj8v7.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return $_2410no16njctdj8me.from(dom.offsetParent).map($_g88mc918ojctdj8tu.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return $_2410no16njctdj8me.from(dom.previousSibling).map($_g88mc918ojctdj8tu.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return $_2410no16njctdj8me.from(dom.nextSibling).map($_g88mc918ojctdj8tu.fromDom);
  };
  var prevSiblings = function (element) {
    return $_7deqd516mjctdj8m9.reverse($_day3hg192jctdj8v6.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_day3hg192jctdj8v6.toArray(element, nextSibling);
  };
  var children$2 = function (element) {
    var dom = element.dom();
    return $_7deqd516mjctdj8m9.map(dom.childNodes, $_g88mc918ojctdj8tu.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return $_2410no16njctdj8me.from(children[index]).map($_g88mc918ojctdj8tu.fromDom);
  };
  ...
  var spot = $_83f0nb18xjctdj8ux.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children$2(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_bqu7p418vjctdj8un = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants$1($_4dkqzb18rjctdj8uc.body(), predicate);
  };
  var ancestors$1 = function (scope, predicate, isRoot) {
    return $_7deqd516mjctdj8m9.filter($_bqu7p418vjctdj8un.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_7deqd516mjctdj8m9.filter($_bqu7p418vjctdj8un.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_7deqd516mjctdj8m9.filter($_bqu7p418vjctdj8un.children(scope), predicate);
  };
  var descendants$1 = function (scope, predicate) {
    var result = [];
    $_7deqd516mjctdj8m9.each($_bqu7p418vjctdj8un.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all = function (selector) {
    return $_3z157z19gjctdj8w2.all(selector);
  };
  var ancestors = function (scope, selector, isRoot) {
    return $_52t93l18qjctdj8tz.ancestors(scope, function (e) {
      return $_3z157z19gjctdj8w2.is(e, selector);
    }, isRoot);
  };
  var siblings = function (scope, selector) {
    return $_52t93l18qjctdj8tz.siblings(scope, function (e) {
      return $_3z157z19gjctdj8w2.is(e, selector);
    });
  };
  var children = function (scope, selector) {
    return $_52t93l18qjctdj8tz.children(scope, function (e) {
      return $_3z157z19gjctdj8w2.is(e, selector);
    });
  };
  var descendants = function (scope, selector) {
    return $_3z157z19gjctdj8w2.all(selector, scope);
  };
  var $_87eir318pjctdj8ty = {
    all: all,
    ancestors: ancestors,
    siblings: siblings,
    children: children,
  ...
  var select = function (selector, root) {
    return $_7deqd516mjctdj8m9.map($_87eir318pjctdj8ty.descendants($_g88mc918ojctdj8tu.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_1ufj7f18njctdj8ts.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$3('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_9tiuzt16ojctdj8mh.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_7deqd516mjctdj8m9.map($_7deqd516mjctdj8m9.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_7deqd516mjctdj8m9.map($_7deqd516mjctdj8m9.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$1 = function (elm) {
    ...
    return $_7deqd516mjctdj8m9.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_41o3uj18mjctdj8tl = { find: find$1 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_9tiuzt16ojctdj8mh.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_7deqd516mjctdj8m9.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_7deqd516mjctdj8m9.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_7deqd516mjctdj8m9.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_7deqd516mjctdj8m9.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_7deqd516mjctdj8m9.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_41o3uj18mjctdj8tl.find(bodyElm);
  ...
  var ClosestOrAncestor = function (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? $_2410no16njctdj8me.some(scope) : $_45ot4v18wjctdj8uv.isFunction(isRoot) && isRoot(scope) ? $_2410no16njctdj8me.none() : ancestor(scope, a, isRoot);
  };

  var first$2 = function (predicate) {
    return descendant$1($_4dkqzb18rjctdj8uc.body(), predicate);
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_g88mc918ojctdj8tu.fromDom(element);
      if (predicate(el))
        return $_2410no16njctdj8me.some(el);
      else if (stop(el))
        break;
    }
    return $_2410no16njctdj8me.none();
  ...
  var sibling$1 = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return $_2410no16njctdj8me.none();
    return child$2($_g88mc918ojctdj8tu.fromDom(element.parentNode), function (x) {
      return !$_3d886r193jctdj8v7.eq(scope, x) && predicate(x);
    });
  };
  var child$2 = function (scope, predicate) {
    var result = $_7deqd516mjctdj8m9.find(scope.dom().childNodes, $_9tiuzt16ojctdj8mh.compose(predicate, $_g88mc918ojctdj8tu.fromDom));
    return result.map($_g88mc918ojctdj8tu.fromDom);
  };
  var descendant$1 = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_g88mc918ojctdj8tu.fromDom(element.childNodes[i])))
          return $_2410no16njctdj8me.some($_g88mc918ojctdj8tu.fromDom(element.childNodes[i]));
  ...
  var first$1 = function (selector) {
    return $_3z157z19gjctdj8w2.one(selector);
  };
  var ancestor = function (scope, selector, isRoot) {
    return $_fl3lus19mjctdj8wu.ancestor(scope, function (e) {
      return $_3z157z19gjctdj8w2.is(e, selector);
    }, isRoot);
  };
  var sibling = function (scope, selector) {
    return $_fl3lus19mjctdj8wu.sibling(scope, function (e) {
      return $_3z157z19gjctdj8w2.is(e, selector);
    });
  };
  var child$1 = function (scope, selector) {
    return $_fl3lus19mjctdj8wu.child(scope, function (e) {
      return $_3z157z19gjctdj8w2.is(e, selector);
    });
  };
  var descendant = function (scope, selector) {
    return $_3z157z19gjctdj8w2.one(selector, scope);
  };
  var closest = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_3z157z19gjctdj8w2.is, ancestor, scope, selector, isRoot);
  };
  var $_7amum519ljctdj8wt = {
    first: first$1,
    ancestor: ancestor,
    sibling: sibling,
    child: child$1,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_8lkych19pjctdj8x6.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_8lkych19pjctdj8x6.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_8lkych19pjctdj8x6.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_8lkych19pjctdj8x6.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_8lkych19pjctdj8x6.postRenderFormat(editor, name)
      });
    });
  };
  var $_9mxvhl19ojctdj8x5 = { register: register };

  var getSpecifiedFontProp = function (propName, rootElm, elm) {
    while (elm !== rootElm) {
      if (elm.style[propName]) {
        var foundStyle = elm.style[propName];
        return foundStyle !== '' ? $_2410no16njctdj8me.some(foundStyle) : $_2410no16njctdj8me.none();
      }
      elm = elm.parentNode;
    }
    return $_2410no16njctdj8me.none();
  ...
  var getComputedFontProp = function (propName, elm) {
    return $_2410no16njctdj8me.from(DOMUtils.DOM.getStyle(elm, propName, true));
  };
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return $_2410no16njctdj8me.from(elm).map($_g88mc918ojctdj8tu.fromDom).filter($_7fw56c18tjctdj8ul.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_8p1s2k19rjctdj8xa = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_9tiuzt16ojctdj8mh.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_8p1s2k19rjctdj8xa.getFontFamily(editor.getBody(), e.element);
  ...
  var $_5ahik619qjctdj8x7 = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_8p1s2k19rjctdj8xa.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_8p1s2k19rjctdj8xa.toPt(px, precision);
  ...
  var $_1o87wm19sjctdj8xf = { register: register$2 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_8lkych19pjctdj8x6.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_8lkych19pjctdj8x6.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_3dgvmh19tjctdj8xi = { register: register$3 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_8lkych19pjctdj8x6.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_7ywzr619ujctdj8xl = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_7deqd516mjctdj8m9.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_7deqd516mjctdj8m9.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_7deqd516mjctdj8m9.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_2pzpq019vjctdj8xq = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_8lkych19pjctdj8x6.postRenderFormat(editor, name),
        onclick: $_8lkych19pjctdj8x6.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_8lkych19pjctdj8x6.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_3ougwt19wjctdj8xu = { register: register$6 };
  ...
  var $_35t4mg19xjctdj8xw = { register: register$7 };
  ...
  var $_ev3jwt19yjctdj8y7 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_7amum519ljctdj8wt.descendant($_g88mc918ojctdj8tu.fromDom(document.body), editor.settings.ui_container).fold($_9tiuzt16ojctdj8mh.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_3dgvmh19tjctdj8xi.register(editor);
    $_9mxvhl19ojctdj8x5.register(editor);
    $_3ougwt19wjctdj8xu.register(editor);
    $_35t4mg19xjctdj8xw.register(editor);
    $_1o87wm19sjctdj8xf.register(editor);
    $_5ahik619qjctdj8x7.register(editor);
    $_7ywzr619ujctdj8xl.register(editor);
    $_ev3jwt19yjctdj8y7.register(editor);
    $_2pzpq019vjctdj8xq.register(editor);
  };
  var $_dbiud319kjctdj8wp = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_8650z8172jctdj8o7,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_btaj0u17fjctdj8pt,
      Panel: Panel,
      Movable: $_18kp43173jctdj8o9,
      Resizable: $_43pn5n17gjctdj8pw,
      ...
      FormatControls: $_dbiud319kjctdj8wp,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = Panel$1();
    $_dbiud319kjctdj8wp.setup(editor);
    $_30t6ts17ijctdj8q0.addToEditor(editor, panel);
    return $_5y47of160jctdj8lb.get(editor, panel);
  });
  var Theme = function () {
  };
