...
var contextmenu = (function () {
  ...
  var $_8ajcg49tjctdj22v = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_9uadx39sjctdj22u.getContextMenu(editor);
  ...
  var $_34xjcl9wjctdj22y = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_9uadx39sjctdj22u.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_34xjcl9wjctdj22y.show(editor, $_8ajcg49tjctdj22v.getPos(editor, e), visibleState, menu);
    });
  };
  var $_7v1tc49rjctdj22s = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_7v1tc49rjctdj22s.setup(editor, visibleState, menu);
    return $_bunqg89qjctdj22r.get(visibleState);
  });
  var Plugin = function () {
  };
