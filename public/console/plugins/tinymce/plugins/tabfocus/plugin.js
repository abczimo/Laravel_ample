...
var tabfocus = (function () {
  ...
  var $_37ktzujcjctdj3is = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_37ktzujcjctdj3is.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_83hpjkj5jctdj3in = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_83hpjkj5jctdj3in.setup(editor);
  });
  var Plugin = function () {
  };
