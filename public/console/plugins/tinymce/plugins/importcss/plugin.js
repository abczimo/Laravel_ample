...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_csyccvdwjctdj2pn.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_csyccvdwjctdj2pn.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_csyccvdwjctdj2pn.getSelectorConverter(editor)) {
      selectorConverter = $_csyccvdwjctdj2pn.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_csyccvdwjctdj2pn.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_csyccvdwjctdj2pn.getCssGroups(editor));
      ...
      if (!$_csyccvdwjctdj2pn.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_csyccvdwjctdj2pn.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_1ifugedrjctdj2pe.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_ezsxdjdqjctdj2pb = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_1ifugedrjctdj2pe.setup(editor);
    return $_ezsxdjdqjctdj2pb.get(editor);
  });
  var Plugin = function () {
  };
