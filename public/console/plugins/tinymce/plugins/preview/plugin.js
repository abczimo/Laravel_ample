...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_no41lhwjctdj3cv.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_no41lhwjctdj3cv.getPreviewDialogWidth(editor);
    var dialogHeight = $_no41lhwjctdj3cv.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_dnngpmhxjctdj3cw.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_7l9omfhujctdj3cq = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_7l9omfhujctdj3cq.open(editor);
    });
  };
  var $_cvblexhtjctdj3co = { register: register };
  ...
  var $_7a7sjthzjctdj3cz = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_cvblexhtjctdj3co.register(editor);
    $_7a7sjthzjctdj3cz.register(editor);
  });
  var Plugin = function () {
  };
