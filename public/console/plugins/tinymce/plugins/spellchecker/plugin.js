...
var spellchecker = (function () {
  ...
  var $_4xkxfnipjctdj3g6 = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      XHR.send({
        url: new URI(pluginUrl).toAbsolute($_936oydirjctdj3g9.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_936oydirjctdj3g9.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_936oydirjctdj3g9.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_al2zbqiwjctdj3gi.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_936oydirjctdj3g9.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_al2zbqiwjctdj3gi.fireSpellcheckStart(editor);
  };
  var $_8x8jl0isjctdj3gc = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, url) {
    var getLanguage = function () {
      return $_936oydirjctdj3g9.getLanguage(editor);
    };
    var getWordCharPattern = function () {
      return $_936oydirjctdj3g9.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_8x8jl0isjctdj3gc.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_frlkh4iqjctdj3g8 = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_8x8jl0isjctdj3gc.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_45ox4uiyjctdj3gr = { register: register };
  ...
  var updateSelection = function (editor) {
    return function (e) {
      var selectedLanguage = $_936oydirjctdj3g9.getLanguage(editor);
  ...
  var getItems = function (editor) {
    return Tools.map($_936oydirjctdj3g9.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_fzpfqrizjctdj3gt = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, word, spans) {
    ...
    Tools.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_8x8jl0isjctdj3gc.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_8x8jl0isjctdj3gc.addToDictionary(editor, pluginUrl, startedState, textMatcherState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_8x8jl0isjctdj3gc.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_8x8jl0isjctdj3gc.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_8x8jl0isjctdj3gc.findSpansByIndex(editor, $_8x8jl0isjctdj3gc.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_2txhb4j0jctdj3h7 = { setup: setup };

  PluginManager.add('spellchecker', function (editor, pluginUrl) {
    if ($_4xkxfnipjctdj3g6.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_936oydirjctdj3g9.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell({});
      $_fzpfqrizjctdj3gt.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_2txhb4j0jctdj3h7.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState);
      $_45ox4uiyjctdj3gr.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_frlkh4iqjctdj3g8.get(editor, startedState, lastSuggestionsState, textMatcherState, pluginUrl);
    }
  });
  var Plugin = function () {
  };
