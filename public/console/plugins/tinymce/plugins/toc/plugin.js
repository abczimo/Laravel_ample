...
var toc = (function () {
  ...
  var $_6szcroqljctdj54s = { create: create };

  var tocId = $_6szcroqljctdj54s.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_eqnb7zqkjctdj54q.getTocClass(editor);
    var headerTag = $_eqnb7zqkjctdj54q.getTocHeader(editor);
    var selector = generateSelector($_eqnb7zqkjctdj54q.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_eqnb7zqkjctdj54q.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_eqnb7zqkjctdj54q.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_93udvrqgjctdj54f.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_93udvrqgjctdj54f.updateToc(editor);
    });
  };
  var $_5le9luqfjctdj54d = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_eqnb7zqkjctdj54q.getTocClass(editor);
  ...
  var $_3u24jpqmjctdj54t = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_93udvrqgjctdj54f.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_eqnb7zqkjctdj54q.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_a09zk9qnjctdj54v = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_5le9luqfjctdj54d.register(editor);
    $_a09zk9qnjctdj54v.register(editor);
    $_3u24jpqmjctdj54t.setup(editor);
  });
  var Plugin = function () {
  };
