...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_dy7nmc9ejctdj20p.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_7pum3k9ajctdj1zz.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_8y0mfo9cjctdj201.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_wtr7o9fjctdj20r = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_3a2xtu99jctdj1zx = {
    open: function (editor) {
      var minWidth = $_7pum3k9ajctdj1zz.getDialogMinWidth(editor);
      var minHeight = $_7pum3k9ajctdj1zz.getDialogMinHeight(editor);
      var currentLanguage = $_wtr7o9fjctdj20r.getCurrentLanguage(editor);
      var currentLanguages = $_wtr7o9fjctdj20r.getLanguages(editor);
      var currentCode = $_8y0mfo9cjctdj201.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_8y0mfo9cjctdj201.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_dy7nmc9ejctdj20p.isCodeSample(node)) {
        $_3a2xtu99jctdj1zx.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_9stnxn98jctdj1zw = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_dy7nmc9ejctdj20p.trimArg($_dy7nmc9ejctdj20p.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_dy7nmc9ejctdj20p.trimArg($_dy7nmc9ejctdj20p.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_ahp3wl9gjctdj20u = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_7pum3k9ajctdj1zz.getContentCss(editor);
  ...
  var $_f2ga1a9hjctdj20w = { loadCss: loadCss };
  ...
  var $_elt6669ijctdj20y = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_ahp3wl9gjctdj20u.setup(editor);
    $_elt6669ijctdj20y.register(editor);
    $_9stnxn98jctdj1zw.register(editor);
    editor.on('init', function () {
      $_f2ga1a9hjctdj20w.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_dy7nmc9ejctdj20p.isCodeSample(ev.target)) {
        $_3a2xtu99jctdj1zx.open(editor);
      }
    });
  });
