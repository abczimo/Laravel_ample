...
var wordcount = (function () {
  ...
  var $_5pbcpkrrjctdj58z = {
    each: each,
    map: map
  };

  var SETS$1 = $_da1xjirpjctdj58u.SETS;
  var OTHER = $_da1xjirpjctdj58u.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_5pbcpkrrjctdj58z.map(string.split(''), memoized);
  };
  var $_9ik7berqjctdj58y = { classify: classify };

  var ci = $_da1xjirpjctdj58u.characterIndices;
  ...
  var $_9lcd0nrsjctdj591 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING = $_da1xjirpjctdj58u.EMPTY_STRING;
  var WHITESPACE = $_da1xjirpjctdj58u.WHITESPACE;
  var PUNCTUATION = $_da1xjirpjctdj58u.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_9ik7berqjctdj58y.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_9lcd0nrsjctdj591.isWordBoundary(map, i)) {
  ...
  var $_3wg1xurojctdj58r = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_3wg1xurojctdj58r.getWords(getTextContent(editor)).length;
  };
  var $_3aol53rnjctdj58q = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_3aol53rnjctdj58q.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_zrni9rmjctdj58p = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_3aol53rnjctdj58q.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_6k6k5ertjctdj594 = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_6k6k5ertjctdj594.setup(editor);
    return $_zrni9rmjctdj58p.get(editor);
  });
  var Plugin = function () {
  };
