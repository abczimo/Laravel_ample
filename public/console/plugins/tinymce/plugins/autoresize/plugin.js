...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_crkn6t83jctdj1w9.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_crkn6t83jctdj1w9.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_crkn6t83jctdj1w9.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_crkn6t83jctdj1w9.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_crkn6t83jctdj1w9.getAutoResizeBottomMargin(editor);
    ...
    if ($_crkn6t83jctdj1w9.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_edmbiz80jctdj1w5.resize(editor, oldSize);
    });
  };
  var $_a0p8ae7zjctdj1w4 = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_a0p8ae7zjctdj1w4.register(editor, oldSize);
      $_edmbiz80jctdj1w5.setup(editor, oldSize);
    }
  });
  var Plugin = function () {
  };
