                ...
                <div class="panel-footer">
                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                        <li class="list-group-item" data-role="task">
                            ...
                            <ul class="assignedto">
                                <li><img src="console/images/users/1.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Steave" /></li>
                                <li><img src="console/images/users/2.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Jessica" /></li>
                                <li><img src="console/images/users/3.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Priyanka" /></li>
                                <li><img src="console/images/users/4.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Selina" /></li>
                            </ul>
                        </li>
                        <li class="list-group-item" data-role="task">
                            <div class="checkbox checkbox-info">
                            ...
                            <ul class="assignedto">
                                <li><img src="console/images/users/3.jpg" alt="user ing" data-toggle="tooltip" data-placement="top" title="Priyanka" /></li>
                                <li><img src="console/images/users/4.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Selina" /></li>
                            </ul>
                        </li>
                        <li class="list-group-item" data-role="task">
                        ...
                        <li class="list-group-item" data-role="task">
                            ...
                            <ul class="assignedto">
                                <li><img src="console/images/users/1.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Assign to Steave" /></li>
                                <li><img src="console/images/users/2.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Assign to Jessica" /></li>
                                <li><img src="console/images/users/4.jpg" alt="user img" data-toggle="tooltip" data-placement="top" title="Assign to Selina" /></li>
                            </ul>
                        </li>
                    </ul>
                </div>
...
@push('scripts')
    ...
    <script src="console/js/dashboard1.js"></script>
